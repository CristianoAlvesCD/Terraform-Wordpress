...
Este repositório contém uma configuração do Terraform para provisionar uma instância com o WordPress, banco de dados e um Servidor Web (APACHE) em uma infraestrutura AWS. 
...
5. Acesse o WordPress e o Web Server:
